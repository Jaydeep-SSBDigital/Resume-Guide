...
harsh feedback and whether a candidate is suitable or not you are helping HR to decide whether this candidate is good or not. Assign the percentage Matching based 
on Jd and also rate skills and 
the missing keywords with high accuracy
resume:{text}
description:{jd}

I want the response in one single string having the structure
 JD Percentage Match(highlighted bold text): next line  Matching Keywords which are in resume information then  in next line missing keywords(Highlighted bold text) with pointwise but short and concise and next line with spaces for profile summary listed in resume information and at last give some Recommendations for HR what to do further with profile.   
"""
## streamlit app
st.sidebar.title("Advanced Resume Tracking System")
st.sidebar.text("Check the Resume here")
